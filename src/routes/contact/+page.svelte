      ...
      <form method="POST" action="?/startNewssletter" class="space-y-3">
        <div class="text-white">
          ...
          <input
            ...
            id="name"
            name="name"
            class="block w-full mt-1 border-b border-gray-300 bg-gray-500 focus:ring-0 focus:border-black"
          />
          {#if form?.errors?.name}
        ...
        <div>
          <label for="email" class="block text-sm font-medium italic"
            >E-mail</label
          >
          <input
        ...
        <div>
          <label for="message" class="block text-sm font-medium italic"
            >Your message</label
          >
          <textarea
        ...
        <div class="flex justify-end">
          <button
            type="submit"
            class="px-6 py-2 text-sm font-medium text-white hover:bg-[#f53b57] border rounded-md border-transparent bg-purple-800 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 transition disabled:opacity-25"
            >Send</button
          >
        </div>
      </form>
